...
public class MapActivity extends AppCompatActivity implements
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        // check if the permission has been granted by google api
        // if so get current location on map
    ...
    private void init(){
        ...
        // building google api connection
        ...
        // creating new place autocomplete adapter
        mPlaceAutocompleteAdapter = new PlaceAutocompleteAdapter(this, mGoogleApiClient,
                LAT_LNG_BOUNDS, null);

        // setting adapter to searchText
        ...
        // going back to current location
        mGps.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.d(TAG, "onClick: clicked gps icon");
                // not sure if we want to clear the map when we go back to current locaiton
                // I think it makes sense to clear not sure.
                mMap.clear();
                getDeviceLocation();
            }
        });

        //dropping pin on the map.
        mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
            @Override
            public void onMapLongClick(LatLng latLng) {
                //not sure if we want to clear the map or not.
                // which I think makes sense to clean.
                mMap.clear();
    ...
    // this method moves the camera to
    // Latlan: the place
    // Zoom: default is 15f
    // placeinfo
    ...
    // pin location which does not contains placeinfo
    ...
    // check location permission if has granted as user for the permission.
